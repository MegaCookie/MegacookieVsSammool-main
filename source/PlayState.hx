...
class PlayState extends MusicBeatState
{
	...
	var platesky:BGSprite;
	var darksky:BGSprite;
	var wind1:BGSprite;
	var wind2:BGSprite;
	var wind3:BGSprite;
	var blackTransition:BGSprite;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'theplates':
			     platesky = new BGSprite('platessky', -600, -300, 0.7, 0.7);
                 add (platesky);
			...
			case 'thefinale':
				 ...
				 add(destructor);
				 var plates:BGSprite = new BGSprite('plateslandmines', -600, -200, 1, 1);
                 add (plates);
	
			case 'carstage':
				 GameOverSubstate.loopSoundName = 'gameOverAlt';
				 GameOverSubstate.endSoundName = 'gameOverAltEnd';
			     platesky = new BGSprite('platessky', -700, -500, 0.7, 0.7);
                 add (platesky);
				 var bgcar = new BGSprite('carbackground', -2000, 200, 0.7, 0.7,['CARS'], true);
				 add(bgcar);
				 var wind1 = new BGSprite('horizontalwind', -1800, 0, 1, 1,['airflow'], true);
				 add(wind1);
				 var wind2 = new BGSprite('horizontalwind', -1800, -500, 1, 1,['airflow'], true);
				 add(wind2);
				 var wind3 = new BGSprite('horizontalwind', -1800, 300, 1, 1,['airflow'], true);
				 add(wind3);
				 var backcar:BGSprite = new BGSprite('backcar', -100, 500, 1, 1);
                 add (backcar);
				 var frontcars:BGSprite = new BGSprite('frontcars', -800, 400, 1, 1);
                 add (frontcars);

			case 'sky':
			     darksky = new BGSprite('darksky', -300, -300, 0.7, 0.7);
				 darksky.visible = true;
                 add (darksky);
				 wind1 = new BGSprite('windeffect', -20, -1000, 1, 1,['airflow'], true);
				 wind1.visible = true;
				 add(wind1);
				 wind2 = new BGSprite('windeffect', 600, -1000, 1, 1,['airflow'], true);
				 wind2.visible = true;
				 add(wind2);
				 wind3 = new BGSprite('windeffect', -1200, -600, 1, 1,['airflow'], true);
				 wind3.visible = true;
				 add(wind3);
				 GameOverSubstate.characterName = 'sammool-flying';
				 GameOverSubstate.loopSoundName = 'gameOverAlt';
				 GameOverSubstate.endSoundName = 'gameOverAltEnd';
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'gameover change':
				 ...
				 GameOverSubstate.characterName = (value1);
			...
			case 'Camera Zoom': // oh shit its camera Zoom
		
				var zoomValue:Int = Std.parseInt(value1);				
				defaultCamZoom = zoomValue;
				

			case 'Camera Visibility': // oh shit its camera ALPHA
				var time:Float = Std.parseFloat(value2);
				switch(value1.toLowerCase().trim()) {
					case '0':
						FlxTween.tween(camera, { alpha: 1 }, (time));
					case '1':
						FlxTween.tween(camera, { alpha: 0 }, (time));
				}


            case 'UI Visibility': // this does the alpha tween shit lmoa
				var time:Float = Std.parseFloat(value2);
				switch(value1.toLowerCase().trim()) {
					case '0':
						FlxTween.tween(camHUD, { alpha: 1 }, (time));
					case '1':
						FlxTween.tween(camHUD, { alpha: 0 }, (time));
				}
